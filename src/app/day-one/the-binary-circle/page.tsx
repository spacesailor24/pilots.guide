    ...
    <AppLayout>
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-300 leading-relaxed mb-6">
          ...
          guide will teach you how to win micro-battles and control engagements.
        </p>
        ...
        <div className="bg-zinc-900 rounded-lg border border-red-600 p-6 shadow-lg mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-black/30 p-4 rounded-md">
              <h3 className="font-medium text-red-400 mb-2">Why It Works</h3>
              <p className="text-sm text-gray-400">
                Master Modes punishes aggressive pushing. The Binary Circle
                keeps you in the optimal 300m engagement range while maintaining
                nose-on-target time.
              </p>
            </div>
            <div className="bg-black/30 p-4 rounded-md">
              <h3 className="font-medium text-red-400 mb-2">Key Principle</h3>
              <p className="text-sm text-gray-400">
        ...
        <div className="bg-zinc-900 rounded-lg border border-red-600 p-6 shadow-lg mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-black/30 p-4 rounded-md">
              ...
              <p className="text-sm text-gray-400">
                Don't fight the speed wall - it will punish you. At 300m, focus
                purely on applying damage rather than maneuvering.
              </p>
            </div>
            <div className="bg-black/30 p-4 rounded-md">
              <h3 className="font-medium text-red-400 mb-2">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start">
              ...
              <p className="text-gray-300">
                ...
                energy. Use minimal stick movement - quarter inputs are usually
                enough.
              </p>
            </div>
            <div className="flex items-start">
              ...
              <p className="text-gray-300">
                <strong>Atmosphere advantage</strong> - The Binary Circle works
                even better in atmosphere where knife fighting becomes easier.
              </p>
            </div>
          </div>
        </div>
