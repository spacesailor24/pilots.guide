    ...
    <AppLayout>
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-300 leading-relaxed mb-6">
          Master the defensive art of PIP deflection to become unpredictable and
          harder to hit. This advanced technique shifts your momentum in
        ...
        <div className="bg-zinc-900 rounded-lg border border-red-600 p-6 shadow-lg mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-black/30 p-4 rounded-md">
              <h3 className="font-medium text-red-400 mb-2">Defensive Tool</h3>
              <p className="text-sm text-gray-400">
                Primarily used to avoid incoming fire by creating unpredictable
                movement patterns that disrupt enemy aim predictions.
              </p>
            </div>
            <div className="bg-black/30 p-4 rounded-md">
              <h3 className="font-medium text-red-400 mb-2">Momentum Shift</h3>
              <p className="text-sm text-gray-400">
          ...
          <div className="space-y-4">
            <div className="bg-black/30 p-4 rounded-md">
              ...
              <div className="bg-yellow-900/20 border border-yellow-600 p-3 rounded mt-2">
                <p className="text-xs text-yellow-300">
                  <strong>Warning:</strong> If you don't neutralize first, your
                  PIP will only gradually move towards your new direction,
            ...
            <div className="bg-black/30 p-4 rounded-md">
              ...
              <p className="text-sm text-gray-400">
                ...
                direction you want to deflect. Most ships have stronger vertical
                strafe than lateral.
              </p>
            </div>
        ...
        <div className="bg-zinc-900 rounded-lg border border-red-600 p-6 shadow-lg mb-6">
          ...
          <div className="bg-red-900/20 border border-red-700 p-4 rounded-md mt-4">
            <p className="text-sm text-red-300">
              ...
              deflecting won't prevent the majority of damage and will throw off
              your own aim. Time your deflections strategically.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-black/30 p-4 rounded-md">
              ...
              <ul className="text-xs text-gray-500 space-y-1">
                ...
                <li>• Focus on maintaining combat effectiveness throughout</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start">
              ...
              <p className="text-gray-300">
                ...
                extension and neutralization to create complex evasion patterns
            ...
            <div className="flex items-start">
              ...
              <p className="text-gray-300">
                <strong>Time your deflections</strong> - Don't spam deflection.
                Use it when you see enemy shots converging or when breaking
                through a joust.
              </p>
            </div>
            <div className="flex items-start">
            ...
            <div className="flex items-start">
              ...
              <p className="text-gray-300">
                <strong>Know your ship</strong> - Different ships have different
                strafe capabilities. Learn your ship's strongest strafe axes for
                optimal deflection.
              </p>
            </div>
          </div>
