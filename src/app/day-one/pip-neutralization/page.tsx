    ...
    <AppLayout>
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-300 leading-relaxed mb-6">
          <>
            Master the fundamental technique of PIP neutralization to
            dramatically improve your hit rate and aiming precision in Star
            Citizen dogfighting. This essential skill reduces projectile travel
            time and increases combat effectiveness.
          </>
        </p>
        ...
        <div className="bg-gradient-to-r from-red-900/20 to-red-800/20 rounded-lg border border-red-600 p-6 mt-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start">
              ...
              <p className="text-gray-300">
                <>
                  <strong>Practice in Arena Commander</strong> - Use Pirate
                  Swarm or Free Flight to perfect your neutralization without
                  risking your ship.
                </>
              </p>
            </div>
