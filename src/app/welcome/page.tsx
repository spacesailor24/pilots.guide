    ...
    <AppLayout>
      ...
      <div className="mb-8 text-center">
        <div className="flex items-center justify-center mb-4">
          ...
          <h1 className="text-4xl font-bold text-white">Schola Volandi</h1>
        </div>
        ...
        <p className="text-lg text-gray-300 leading-relaxed max-w-3xl mx-auto">
          ...
          Master the art of dogfighting through proven techniques and structured
          training.
        </p>
      </div>
      ...
      <div className="bg-zinc-900 rounded-lg border border-red-600 p-6 shadow-lg mb-6">
        ...
        <p className="text-gray-300 mb-4">
          Schola Volandi is a comprehensive combat training program designed to
          transform novice pilots into skilled combatants. Our curriculum
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-black/30 p-4 rounded-md">
            ...
            <p className="text-sm text-gray-400">
              Progressive training modules from fundamentals to advanced tactics
            </p>
          </div>
          <div className="bg-black/30 p-4 rounded-md">
            <h3 className="font-medium text-red-400 mb-2">Combat Proven</h3>
            <p className="text-sm text-gray-400">
              Techniques refined through countless engagements in the 'Verse
            </p>
          </div>
          <div className="bg-black/30 p-4 rounded-md">
            <h3 className="font-medium text-red-400 mb-2">Practical Focus</h3>
            <p className="text-sm text-gray-400">
      ...
      <div className="bg-gradient-to-r from-red-900/20 to-red-800/20 rounded-lg border border-red-600 p-6 mb-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-300">
            ...
            <strong className="text-red-400">why</strong> behind each technique.
            You'll learn not just what to do, but when and why to do it. This
            deeper understanding allows you to adapt techniques to your personal
            flying style and ship capabilities.
          </p>
        </div>
      </div>
